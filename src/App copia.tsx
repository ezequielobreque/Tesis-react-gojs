          ...
          produce((draft: AppState) => {
            if (sel) {
              if (sel instanceof go.Node) {
                ...
                console.log("🚀 ~ file: App.tsx ~ line 102 ~ App ~ produce ~ idx", idx)
                ...
                console.log("🚀 ~ file: App.tsx ~ line 109 ~ App ~ produce ~ idx", sel)
                const idx = this.mapLinkKeyIdx.get(sel.key);
                console.log("🚀 ~ file: App.tsx ~ line 109 ~ App ~ produce ~ idx", idx)
