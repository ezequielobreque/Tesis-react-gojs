...
export function markInputErrors(
  lexErrors: any,
  parseErrors: any,
  inputEditor: any,
  inputEditorMark: any[],
...
export function onInputEditorContentChange(
  inputEditor: any,
  inputEditorMarkers: any,
  setInputMarket: any,
  lex: any
) {
...
export function FindErrors(
  ...
  mapOfRepeatsObjects.forEach((x: any) => {
    const marker = codemirror.markText(
      x.children.StringEntity[0].startLine,
      x.children.StringEntity[0].endLine,
      {
        className: "markTextError",
